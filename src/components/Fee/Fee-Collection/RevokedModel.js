...
const RevokedModel = ({
  ...
  const handleCancleClick = async () => {
    try {
      if (revokeReason) {
        const dataToRevoke = canceleData?.dataToRevoke;
    ...
    <Card>
      ...
      <CardContent>
        ...
        <Grid container spacing={1} wrap="wrap" mt={1} ml={4}>
          ...
          <Grid item md={6} sm={6} xs={6}>
            <Typography>{canceleData?.dataToRevoke?.log?.receiptNo}</Typography>
          </Grid>
          <Grid item md={6} sm={6} xs={6}>
          ...
          <Grid item md={6} sm={6} xs={6}>
            <Typography>
              {moment(canceleData?.dataToRevoke?.log?.date).format(
                "DD-MMM-YYYY"
              )}
            </Typography>
          </Grid>
        ...
        <Grid container spacing={1} wrap="wrap" mt={0.3} ml={4}>
          ...
          <Grid item md={6} sm={6} xs={6}>
            <Typography>
              {canceleData?.dataToRevoke?.log?.payableAmount}
            </Typography>
          </Grid>
          <Grid item md={6} sm={6} xs={6}>
          ...
          <Grid item md={6} sm={6} xs={6}>
            <Typography>
              {canceleData?.dataToRevoke?.log?.approvedBy?.name}
            </Typography>
          </Grid>
        </Grid>
        <Grid container spacing={1} wrap="wrap" mt={0.3} ml={4}>
          ...
          <Grid item md={6} sm={6} xs={6}>
            <Typography>
              {canceleData?.dataToRevoke?.log?.cancelBy?.name}
            </Typography>
          </Grid>
        </Grid>
